...
DECLARE_INSN(ss_fill_mode, MATCH_SS_FILL_MODE, MASK_SS_FILL_MODE)
DECLARE_INSN(ss_stride, MATCH_SS_STRIDE, MASK_SS_STRIDE)
DECLARE_INSN(ss_add_port, MATCH_SS_ADD_PORT, MASK_SS_ADD_PORT)
...
DECLARE_INSN(ss_wait_df, MATCH_SS_WAIT_DF, MASK_SS_WAIT_DF)
